...
def get_match_titles(match_index):
    date = get_match_date(match_index)
    team1 = get_team_name_one(match_index)
    team2 = get_team_name_two(match_index)
...
def get_team_name_one(match_index):
